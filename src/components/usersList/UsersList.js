...
const UsersList = ({ users, selectUser, user1 }) => {
  ...
  return (
    <div className=" dark:text-white/90 h-screen bg-white dark:bg-slate-800 dark:border-l-[0.2px] dark:border-white/40 w-full">
      ...
      <div className="overflow-y-auto overflow-x-hidden">
        ...
        <div className="w-full overflow-y-auto h-full flex flex-col gap-2 dark:text-white/90">
          {!users.length ? (
            <p>No chats yet...</p>
          ) : (
            users.map((user) => (
